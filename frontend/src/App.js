...
import StockDispatched from "./autharea/pages/kitchen/StockDispatched";
import CreateRoom from "./autharea/pages/manager/CreateRoom";
import NewMenu from "./autharea/pages/restaurant/NewMenu";
import EditMenu from "./autharea/pages/manager/EditMenu";
import UpdateStock from "./autharea/pages/manager/UpdateStock";
import UpdateStockDispatched from "./autharea/components/manager/UpdateStockDispatched";
import UpdateRestaurant from "./autharea/pages/manager/UpdateRestaurant";
import UpdateBarOrders from "./autharea/pages/manager/UpdateBarOrders";
import UpdateFreeRoom from "./autharea/pages/manager/UpdateFreeRoom";
    ...
    <div className="App">
      ...
      <Routes>
        ...
        <Route element={<ManagerProtectedRoutes />}>
          ...
          />
          <Route
            path="/manager/stock-inventory/:id"
            element={
              <Layout>
                <UpdateStock />
              </Layout>
          ...
          <Route
            name="ideas"
            path="manager/stock-dispatched/update/:id"
            element={
              <Layout>
        ...
        <Route element={<ReceptionistProtectedRoutes />}>
          ...
          />
          <Route
            path="/receptionist/free-rooms/:id"
            element={
              <Layout>
                <UpdateFreeRoom />
              </Layout>
          ...
          />
          <Route
            path="/receptionist/create-rooms"
            element={
              <Layout>
                <CreateRoom />
              </Layout>

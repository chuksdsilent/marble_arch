...
const Laundry = () => {
    ...
    useEffect(async () => {
        try {
            const response = (params === "today") ? await LaundryServices.todayLaundry() : await LaundryServices.allLaundry()
    ...
    const onFinish = async (values) => {
        ...
        try {
            const response = await LaundryServices.searchLaundry(data);
            setDataSource(response.data)
        } catch (error) {
            console.log(error);
        }

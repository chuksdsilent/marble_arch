...
const UpdateBarOrders = () => {
    ...
    useEffect(async () => {
        try {
            const response = await RestaurantServices.getRestaurantOrder(id);

            console.log(response.data)
            form.setFieldsValue({
                name: response.data.menuId.name,
    ...
    const onFinish = async (values) => {
        ...
        setSubmitting(true)
        try {
            const response = await RestaurantServices.updateRestaurantOrder(id, values);
            form.resetFields();
...
export default UpdateBarOrders
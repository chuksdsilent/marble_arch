...
const BookingWithOldGuest = () => {
    ...
    const onFinish = async (values) => {
        ...
        try {
            const response = await BookingServices.bookingWithOldGuest(values);
            form.resetFields();
        ...
        <FormStyles>
            <div>
                ...
                <Card
                    ...
                    type="inner"
                >
                    <h4>Reservation With Old Guest</h4>
                    <Divider />
                    <Form
                        form={form}
                        labelCol={{
...
export default BookingWithOldGuest
...
const StockDispatched = () => {
    ...
    useEffect(async () => {
        try {
            const response = (params === "today") ? await DispatchedStocksServices.todayStockDispatched() : await DispatchedStocksServices.managerDispatchedStocks()
...
export default StockDispatched